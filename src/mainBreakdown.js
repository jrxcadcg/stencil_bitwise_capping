...
function init() {
  ...
  const geometry = new THREE.CylinderGeometry(1, 1, 0.5, 100);
  ...
  const planeGroups = [ { planes: planes, colorHue: 0.0 },
                        ...
                        { planes: planes2, colorHue: 0.5 },
                        { planes: planes3, colorHue: 0.75 } ];
 ...
 let offsetv =  new THREE.Vector3(set[ 0 ].normal.x*0.3, 0,set[ 1 ].normal.z*0.3 );
