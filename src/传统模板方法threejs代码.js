...
function createModels() {
  ...
  // 共享资源
  const geometry = new THREE.TorusGeometry(0.4, 0.15, 220, 600); // 也可换 Sphere/TorusKnot
  // 半径 0.4，水平分段 64，垂直分段 32
//const geometry = new THREE.SphereGeometry(0.5, 64, 32);
  ...
  for (let i = 0; i < params.modelCount; i++) {
    ...
    const capColor  =  new THREE.Color().setHSL(hue, 0.7, 0.55);    // 补面互补色
    ...
    // polygonOffsetUnits: i*2       // 每个 i 增加一点偏移
    });
